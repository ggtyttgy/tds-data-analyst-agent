...
app = FastAPI()
EXPECTED_TOKEN = os.getenv("DATA_ANALYST_TOKEN", "changeme")
...
async def analyze_data(
    ...
    if files:
        for f in files:
            ...
            # You can extend to other file types if needed
